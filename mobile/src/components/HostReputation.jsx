  ...
  return (
    <View style={styles.card}>
      ...
      <Text style={styles.paragraph}>
        Verified hosts have a stronger signal and higher trust. Build your reputation by hosting events, collecting check-ins, and staying within the local grid.
      </Text>
      <View style={styles.badgeRow}>
        <View style={styles.badge}><Text style={styles.badgeText}>★ Trusted</Text></View>
