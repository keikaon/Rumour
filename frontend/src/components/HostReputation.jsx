  ...
  return (
    <div className="bg-zinc-900/50 rounded-xl p-4 border border-zinc-800/50">
      <div className="flex justify-between items-center mb-4">
        <p className="text-[10px] font-bold text-zinc-400 uppercase tracking-[0.2em]">Host Reputation</p>
        
        {/* If they pass the test, show the badge! */}
        {isVerifiedHost && (
          <span className="text-[8px] text-amber-400 font-black uppercase tracking-widest bg-amber-500/10 border border-amber-500/20 px-2 py-0.5 rounded-full shadow-[0_0_10px_rgba(245,158,11,0.2)]">
            ★ Verified
          </span>
        )}
      </div>
